# Contributing to StreamTransport
...
```bash
dotnet restore StreamTransport.slnx
dotnet build StreamTransport.slnx
dotnet test StreamTransport.slnx
```
...
```bash
dotnet test StreamTransport.slnx --filter "TestCategory!=Integration"
```
