...
public sealed class SrtpKeyDerivationTests
{
    ...
    public void Derive_Aes128_MatchesRfc3711Vector()
    {
        ...
        byte[] encKey = SrtpKeyDerivation.Derive(
            masterKey,
            masterSalt,
            SrtpKeyDerivation.LabelRtpEncryption,
            16
        );
        byte[] salt = SrtpKeyDerivation.Derive(
            masterKey,
            masterSalt,
    ...
    public void Session_ClientToServer_AndBack_RoundTrips()
    {
        ...
        var keying = new SrtpKeyingMaterial(
            ...
            ClientMasterKey: Random(16),
            ClientMasterSalt: Random(12),
            ServerMasterKey: Random(16),
            ServerMasterSalt: Random(12)
        );
    ...
    public void Session_Aes256Gcm_RoundTrips()
    {
        var keying = new SrtpKeyingMaterial(
            ...
            ClientMasterKey: Random(32),
            ClientMasterSalt: Random(12),
            ServerMasterKey: Random(32),
            ServerMasterSalt: Random(12)
        );
